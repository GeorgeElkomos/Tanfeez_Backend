...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='If set, assignments will include users with this level', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stage_templates', to='user_management.xx_userlevel'),
        ),
        migrations.AddField(
            model_name='approvalworkflowstageinstance',
            name='stage_template',
